...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-DXmzoBRC.js', import.meta.url).href),import:true},'vue-router':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-router-nRFHZqUY.js', import.meta.url).href),import:true}};
